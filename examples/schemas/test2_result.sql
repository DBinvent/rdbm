...
ALTER TABLE test_schema.test_ref_table OWNER TO postgres;
CREATE SEQUENCE test_schema.test_ref_table_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
ALTER TABLE test_schema.test_ref_table_id_seq OWNER TO postgres;
ALTER SEQUENCE test_schema.test_ref_table_id_seq OWNED BY test_schema.test_ref_table.id;
...
ALTER TABLE ONLY test_schema.test_ref_table
    ADD CONSTRAINT test_ref_table_pkey PRIMARY KEY (id);
ALTER TABLE ONLY test_schema.test_table
    ADD CONSTRAINT test_table_pkey PRIMARY KEY (id);
ALTER TABLE ONLY test_schema.test_table
    ADD CONSTRAINT fk_test_schema_test_table_test_ref_table FOREIGN KEY (tr) REFERENCES test_schema.test_ref_table(id);
